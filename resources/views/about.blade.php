...
<div class="container mb-5">
    ...
    <div class="row us mb-5">
        <div class="col-md-4" style="padding:20px;">
            <img src="{{URL::asset('svg/check mark simplified.svg')}}" alt="" height="30px" ><h3 class="t-16pt">We are</h3>
            <ul class="t-13pt">
        ...
        <div class="col-md-4">
            <img src="{{URL::asset('svg/x mark.svg')}}" alt="" height="30px"><h3 class="t-16pt">We are Not</h3>
            <ul class="t-13pt">
                <li>Contractors</li>
        ...
        <div class="col-md-4">
            <img src="{{URL::asset('svg/Target.svg')}}" alt="" height="30px"><h3 class="t-16pt">What we do</h3>
            <ul class="t-13pt">
