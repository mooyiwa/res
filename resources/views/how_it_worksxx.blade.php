...
<div class="mt-5 p-5" style="background-color:#383838; padding: 50px 20px;">
  <div class="container">
    ...
    <div class="text-center" style="color:white;">
      ...
      <a href="/site/signup"><button class="btn btn-des mt-3">Invest Now</button></a>
    </div>
  </div>
</div>
...
<div class="container mt-5">
  <div class="text-center">
    <h2>What if I need my money back before maturity?</h2>
    <p>Inform us on your dashboard whenever you wish to sell some or all of your loan notes.</p>
    <p>Loan notes are sold or repurchased at Par Value:</p>
...
<div style="background-color:#35b1e0; height: 20px;">
</div>
