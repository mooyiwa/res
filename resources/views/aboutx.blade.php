...
<div style="background:#efefef; padding: 30px;" class="mb-5">
    <div class="container">
    <img src="{{URL::asset('svg/two hands.svg')}}" alt="" class="img-fluid pic">
...
<div class="container mb-5">
    <h3>Be part of a community of lenders earning upto 30% returns on 
        property development investment.</h3>
    <div class="row">
        <div class="col-md-6">
            <img src="{{URL::asset('svg/chart.svg')}}" alt="" class="img-fluid pic">
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
        <img src="{{URL::asset('svg/business men.svg')}}" alt="" class="img-fluid pic">
        </div>
    </div>
    <br>
    <div class="row">
        <div class="col-md-4">
        <img src="{{URL::asset('svg/operator.svg')}}" alt="" class="img-fuid pic">
        </div>
        <div class="col-md-8">
    ...
    <div class="row us">
        <div class="col-md-4">
            <img src="{{URL::asset('svg/check mark simplified.svg')}}" alt="" height="30px" ><h2>We are</h2>
            <ul>
        ...
        <div class="col-md-4">
            <img src="{{URL::asset('svg/x mark.svg')}}" alt="" height="30px"><h2>We are Not</h2>
            <ul>
                <li>Contractors</li>
        ...
        <div class="col-md-4">
            <img src="{{URL::asset('svg/Target.svg')}}" alt="" height="30px"><h2>What we do</h2>
            <ul>
