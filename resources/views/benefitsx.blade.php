...
<div class="container mt-5">
    ...
    <div class="text-center">
        <p>We offer debt-based investments where you can invest and earn up to 30%</p>
        <a href='/site/signup'><button class="btn btn-des mb-3">INVEST NOW</button></a>

        <p>For more information, contact +2349054444424</p>
    </div>
