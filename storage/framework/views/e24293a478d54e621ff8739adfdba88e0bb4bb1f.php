...
<li><?php echo e(session()->get('first')); ?> <?php echo e(session()->get('last')); ?></li>

<li class='tudd'><label>Project</label></li>
<li>
 <div class="input-group-lg">
  <input type="hidden" name="asset" id="asset" class="form-control" required="required" 
 value="<?php echo e(session()->get('asset')); ?>"> <?php echo e(session()->get('asset')); ?>
...
<li>
 ...
 value="<?php echo e(session()->get('location')); ?>"> <?php echo e(session()->get('location')); ?>
...
<li>
 ...
 value="<?php echo e(session()->get('amount')); ?>"> NGN <?php echo e(session()->get('amount')); ?> / 12 months
 </div>
</li> 
...
<li>
 ...
 value="<?php echo e(session()->get('rate')); ?>"> <?php echo e(session()->get('rate')); ?>
       ...
       <!-- The amount box is not displayed by default. Will stay so unless the GET parameter amountinkobo is a valid integer -->
        <fieldset class="form-group" id="amountinnaira" style="display:none">
          <label for="amount-in-naira">Amount (in Naira)</label>
              ...
              <div class=""></div>
              <input class="form-control" name="amount" id="amount-in-naira" required="required" type="hidden" value="<?php echo e(session()->get('amount')); ?>" />
              <div class=""></div>
        </fieldset>
