...
<div class="container">
  ...
  <div class="row mt-5 mb-5 text-center" id="property">
    <div class="col-lg-4 col-md-12">
      <img class="mb-2" src="<?php echo e(URL::asset('svg/gear.svg')); ?>" height="70px"/>
    ...
    <div class="col-lg-4 col-md-12">
      <img class="mb-2" src="<?php echo e(URL::asset('svg/housing loan.svg')); ?>" height="70px"/>
    ...
    <div class="col-lg-4 col-md-12">
      <img class="mb-2" src="<?php echo e(URL::asset('svg/loan note.svg')); ?>" height="70px"/>
...
<div class="mt-5 p-5" style="background-color:#287aa7;">
  <div class="container">
    <div class="row mt-5">
      ...
      <div class="col-md-6">
        <img class="img-fluid pic" src="<?php echo e(URL::asset('svg/how safe is my money.svg')); ?>" alt="">
      </div>
    </div>
  </div>
</div>
<div class="container mt-5">
<img src="<?php echo e(URL::asset('img/sample-web.jpg')); ?>" class="img-fluid web-view" alt="">
<img src="<?php echo e(URL::asset('img/sample-mobile.jpg')); ?>" class="img-fluid mobile-view" alt="">
</div>
...
<div class="mt-5 p-5" style="background-color:#383838; padding: 50px 20px;">
  <div class="container">
    <div class="row" style="color:white;">
      <div class="col-md-3">
      <img src="<?php echo e(URL::asset('svg/updates.svg')); ?>" class="hand-svg" alt="">
      </div>
      <div class="col-md-7">
...
<div class="container mt-5">
  ...
  <div class="row text-center" style="border-bottom:20px solid; border-bottom-color:#35b1e0;">
    ...
    <div class="col-md-2">
      <img src="<?php echo e(URL::asset('img/what-if-i-need-my-money-back.svg')); ?>" height="200px" alt="">
    </div>
  </div>
</div>
...
<div class="container">
  ...
  <div class="row mt-5">
    <div class="col-lg-3 col-md-6">
      <img src="<?php echo e(URL::asset('svg/terraced house.svg')); ?>" alt="" class="img-fluid">
      <div class="card-body">
        <h5 class="card-title text-center">Terraced Houses</h5>
      </div>
    </div>
    <div class="col-lg-3 col-md-6">
      <img src="<?php echo e(URL::asset('svg/detached house.svg')); ?>" alt="" class="img-fluid">
      <div class="card-body">
        <h5 class="card-title text-center">Detached house</h5>
      </div>
    </div>
    <div class="col-lg-3 col-md-6">
      <img src="<?php echo e(URL::asset('svg/semi detached house.svg')); ?>" alt="" class="img-fluid">
      <div class="card-body">
        <h5 class="card-title text-center">Semi detached house</h5>
      </div>
    </div>
    <div class="col-lg-3 col-md-6">
      <img src="<?php echo e(URL::asset('svg/block of flats.svg')); ?>" alt="" class="img-fluid">
      <div class="card-body">
