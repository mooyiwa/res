...
<div class="container">
  ...
  <div class="row mt-5 mb-5 text-center" id="property">
    <div class="col-lg-4 col-md-12">
      <img class="" src="<?php echo e(URL::asset('svg/gear.svg')); ?>" height="207.75px"/>
    ...
    <div class="col-lg-4 col-md-12">
      <img class="" src="<?php echo e(URL::asset('svg/housing loan.svg')); ?>" height="207.75px"/>
    ...
    <div class="col-lg-4 col-md-12">
      <img class="" src="<?php echo e(URL::asset('svg/loan note.svg')); ?>" height="207.75px"/>
...
<div class="container">
  ...
  <div class="row mt-5">
    <div class="col-lg-3 col-md-6 bg-lit">
      <img src="<?php echo e(URL::asset('svg/terraced house.svg')); ?>" alt="">
      <div class="card-body">
        <h5 class="card-title text-center">Terraced Houses</h5>
      </div>
    </div>
    <div class="col-lg-3 col-md-6 bg-lit">
      <img src="<?php echo e(URL::asset('svg/detached house.svg')); ?>" alt="">
      <div class="card-body">
        <h5 class="card-title text-center">Detached house</h5>
      </div>
    </div>
    <div class="col-lg-3 col-md-6 bg-lit">
      <img src="<?php echo e(URL::asset('svg/semi detached house.svg')); ?>" alt="">
      <div class="card-body">
        <h5 class="card-title text-center">Semi detached house</h5>
      </div>
    </div>
    <div class="col-lg-3 col-md-6 bg-lit">
      <img src="<?php echo e(URL::asset('svg/block of flats.svg')); ?>" alt="">
      <div class="card-body">
