<?php $__env->startSection('joinus_content'); ?>
...
<?php echo Form::open(array('action' => 'pagesController@updateJoinUsContent')); ?>
...
<li><span class='msg'><?php echo e(@$msg); ?></span> </li>
 ...
 <li>
  ...
  <textarea name="story" class="" placeholder="" id="editor"><?php echo e($join->story); ?></textarea> 
 </div>
</li> 
