...
<li>
 ...
 <li>
  <div class="input-group-lg">
  <input type="text" name="fb" class="form-control" value="<?php echo e($details->fb); ?>" 
 ...
 <li>
  <div class="input-group-lg">
  <input type="text" name="twitter" class="form-control" value="<?php echo e($details->twitter); ?>" 
  placeholder="@twitter">
 </div>
</li> 
 ...
 <li>
  <div class="input-group-lg">
  <input type="text" name="linkedin" class="form-control" value="<?php echo e($details->linkedin); ?>" 
