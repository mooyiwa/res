...
<div class="container">
    <div class="row">
       ...
       <?php echo $__env->yieldContent('all-cates'); ?>
       <?php echo $__env->yieldContent('editcate'); ?>
       <?php echo $__env->yieldContent('deletecate'); ?>

       <?php echo $__env->yieldContent('pro_author'); ?>
       <?php echo $__env->yieldContent('pro_reader'); ?>

       <?php echo $__env->yieldContent('pro_author_content'); ?>
       <?php echo $__env->yieldContent('pro_reader_content'); ?> 
...
<script>var editor = new Jodit('#textarea');</script>
