    ...
    <div class="row">
        <div class="col-md-6 col-sm-12 d-flex ist-col" id="footer-col">
            ...
            <div class="footer-add text-center">
                ...
                <a href=""><li class="m-1"><img src="<?php echo e(URL::asset('svg/linkedin.svg')); ?>" alt="" height="30px"></li></a>
                <a href=""><li class="m-1"><img src="<?php echo e(URL::asset('svg/facebook.svg')); ?>" alt="" height="30px"></li></a>
                <a href=""><li class="m-1"><img src="<?php echo e(URL::asset('svg/twitter.svg')); ?>" alt="" height="30px"></li></a>
                <a href=""><li class="m-1"><img src="<?php echo e(URL::asset('svg/instagram.svg')); ?>" alt="" height="30px"></li></a>
                </ul>
            </div>
        </div>
    </div>
